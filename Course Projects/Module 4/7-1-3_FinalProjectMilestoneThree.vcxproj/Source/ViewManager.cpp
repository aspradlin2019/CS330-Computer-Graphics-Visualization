	...
	ShaderManager *pShaderManager)
{
	...
	m_IsOrthographic = false; // Start in perspective mode
	// default camera view parameters
	g_pCamera->Position = glm::vec3(0.0f, 12.0f, 10.0f);
...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	// Set the scroll callback to handle mouse wheel input for adjusting movement speed
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// process camera moving up and down (Q/E keys)
	...
	// Toggle to Perspective mode (P key)
	...
	// Toggle to Orthographic mode (O key)
