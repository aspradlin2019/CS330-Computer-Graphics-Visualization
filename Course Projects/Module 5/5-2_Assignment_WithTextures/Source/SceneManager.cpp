...
{
	// Load brick texture for the box
	CreateGLTexture("../../Utilities/textures/brickwallbase.jpg", "brickTexture");

	// Load grass texture for the plane
	CreateGLTexture("../../Utilities/textures/greengrassbase.jpg", "grassTexture");

	// Load wood bark texture for the cylinders
	CreateGLTexture("../../Utilities/textures/woodbarkbase.jpg", "woodTexture");

	// Load basketball texture for the sphere
	CreateGLTexture("../../Utilities/textures/basketballtexture.jpg", "basketballTexture");

	// Load cone texture for the cone
	CreateGLTexture("../../Utilities/textures/icecreamconetexture.jpg", "coneTexture");
...
void SceneManager::RenderScene()
{
	...
	// Apply grass texture to the plane
	...
	// Apply wood bark texture to the cylinder
	...
	// apply brick texture to the plane
	...
	// Apply basketball texture to the sphere
	SetShaderTexture("basketballTexture");
	...
	// Apply waffle cone texture to the cone
	SetShaderTexture("coneTexture");
