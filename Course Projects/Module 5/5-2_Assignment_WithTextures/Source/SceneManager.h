...
private:
	...
	// texture identifier for brick texture
	const std::string BRICK_TEXTURE = "brickTexture";
	// texture identifier for grass texture
	const std::string GRASS_TEXTURE = "grassTexture";
	// texture identifier for wood texture
	const std::string WOOD_TEXTURE = "woodTexture";
	// texture identifier for basketball texture
	const std::string BASKETBALL_TEXTURE = "basketballTexture";
	// texture identifier for cone texture
	const std::string CONE_TEXTURE = "coneTexture";
